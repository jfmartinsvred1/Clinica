...
const SideBar = ({ valueLeftSideBar, closeSideBar }: SideBarProps) => {
  ...
  return (
    <div className={'sidebar flex flex-col justify-around fixed top-0 bottom-0 lg:left-0 p-2  w-[300px] overflow-y-auto text-center bg-gray-900 ' + valueLeftSideBar}>
      ...
      <div onClick={()=>{navigate("/createAppointment")}} className='p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-sky-700 text-white '>
        <Plus className='text-sm' />
        <span className='text-[14px] ml-4 text-gray-200'>Cadastrar Consulta</span>
      </div>
      <div onClick={()=>{navigate("/createClient")}} className='p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-sky-700 text-white '>
        <Plus className='text-sm' />
        <span className='text-[14px] ml-4 text-gray-200'>Cadastrar Cliente</span>
      </div>
      <div onClick={()=>{navigate("/createDoctor")}} className='p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-sky-700 text-white '>
        <Plus className='text-sm' />
      ...
      <div onClick={()=>{navigate("/doctors")}} className='p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-sky-700 text-white '>
        <List className='text-sm' />
        <span className='text-[14px] ml-4 text-gray-200'>Médicos</span>
      </div>
      <hr className='my-4 text-gray-600' />
      <div className='group p-2.5 flex items-center rounded-md px-4 duration-300 text-white cursor-pointer'>
      ...
      <div className='group gap-5  p-2.5 flex items-center justify-start rounded-md px-4 duration-300 text-white cursor-pointer'>
